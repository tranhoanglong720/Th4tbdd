package com.example.thtuan4.adapter;
...
public class LanguageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tvLanguageName = (TextView) convertView.findViewById(R.id.txt1);
        TextView tvLanguageName1 = (TextView) convertView.findViewById(R.id.txt2);
        ...
        if (listLanguage != null && !listLanguage.isEmpty()) {
            ...
            tvLanguageName1.setText(language.getNamered());
